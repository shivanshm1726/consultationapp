  ...
  const filterAppointments = () => {
    ...
    switch (activeFilter) {
      case "today":
        ...
        filtered = filtered.filter((apt) => apt.date >= todayStart && apt.date <= todayEnd)
        break
      case "all":
        break
      default:
                        ...
                        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                          ...
                          <div className="text-right">
                            <div className="text-sm text-slate-500 dark:text-slate-400">
                              ...
                              <div>{format(appointment.date, "MMM dd, yyyy")}</div>
                              <div>{format(appointment.date, "hh:mm a")}</div>
                            </div>
                          </div>
                        </div>
                      </div>
